...
function Projects({ }: Props) {
  ...
  return (
    <motion.div
      ...
      className="h-screen md:relative flex overflow-hidden flex-col text-left 
        md:flex-row max-w-full justify-start md:justify-center mx-auto items-center z-0">
      <h3 className="pt-20 md:pt-0 md:absolute top-20 uppercase tracking-[20px] text-gray-500 text-2xl">
        Projects
      </h3>
      <div className="md:relative  w-full flex overflow-x-scroll overall-y-hidden snap-x snap-mandatory z-20
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-screen pt-10 md:pt-36 flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-start md:justify-center 
            px-4 md:p-20 h-screen">
          <Image className="object-scale-down rounded-full w-screen flex-shrink snap-center flex flex-col 
